...
class MyUtils extends Utils {
	public readonly kInvite: RegExp;

	public constructor(client: AxonClient) {
		super(client);
		this.kInvite = /^(discord.gg\/|discordapp.com\/invite\/)([a-z0-9]+)$/gi;
	}
	 ...
	 */
	public hexTOrgb(hex: number | string): [number, number, number] {
