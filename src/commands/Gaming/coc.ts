...
export class PenguCommand extends Command {
    ...
    public async run(message: Message, args: Args) {
        ...
        if (troopLevels) embed.addField(await message.fetchLanguageKey("commands/gamestats:coc.troopLevels"), troopLevels, true);
        if (spellLevels) embed.addField(await message.fetchLanguageKey("commands/gamestats:coc.spellLevels"), spellLevels, true);
        if (heroLevels) embed.addField(await message.fetchLanguageKey("commands/gamestats:coc.heroLevels"), heroLevels, true);
