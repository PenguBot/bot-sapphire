...
-- Permissions
	...
	"musicDJs" VARCHAR(19)[] DEFAULT ARRAY[]::TEXT[] NOT NULL,

-- Roles
  "autoRoleIDs" VARCHAR(19)[] DEFAULT ARRAY[]::TEXT[] NOT NULL,
	"selfRoleIDs" VARCHAR(19)[] DEFAULT ARRAY[]::TEXT[] NOT NULL,
  "adminRoleIDs" VARCHAR(19)[] DEFAULT ARRAY[]::TEXT[] NOT NULL,
  "modRoleIDs" VARCHAR(19)[] DEFAULT ARRAY[]::TEXT[] NOT NULL,
  "staffRoleIDs" VARCHAR(19)[] DEFAULT ARRAY[]::TEXT[] NOT NULL,
  "musicDJRoleIDs" VARCHAR(19)[] DEFAULT ARRAY[]::TEXT[] NOT NULL,
...
CREATE TABLE IF NOT EXISTS "Users" (
  "id" SERIAL PRIMARY KEY NOT NULL,
	...
	"profileBackground" TEXT NOT NULL DEFAULT "default",
	"unlockedBackgrounds" TEXT[] DEFAULT ARRAY[]::TEXT[] NOT NULL,
	"reputationPoints" INTEGER NOT NULL DEFAULT 0,
	"repcooldown" INTEGER NOT NULL DEFAULT 0,
	"upvoteTimestamp" INTEGER NOT NULL DEFAULT 0,
